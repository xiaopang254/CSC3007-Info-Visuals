...
*   Data about several traffic accidents resulting in injuries can be found in the public records of the Singapore Police Force (SPF) public data. However, SPF released publicly available SingStat data only goes up from 2012 to 2022; the years 2023, 2011, and 2020 are absent [^Singstat].
