...
* *readr* for data import. *tidyverse* for data transformation. *ggplot2* for visualization based on the grammar of graphics. *knitr* for dynamic document generation. 
