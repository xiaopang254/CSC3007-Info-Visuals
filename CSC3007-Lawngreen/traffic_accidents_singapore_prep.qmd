...
create_plot <- function(data, title, line_color, point_color, text_height, arrow_height, label_height) {
  ...
  ggplot(data, aes(x = Year, y = Accidents)) +
    ...
    geom_label_repel(
      ...
      nudge_y = ifelse(data$Year == 2020, 0, label_height),
      nudge_x = ifelse(data$Year == 2020, -0.1, 0),
      fill = line_color,
      color = "white",
      fontface = "bold",
      box.padding = 0.3, 
...
vehicle_plot <- create_plot(vehicle_data, "Vehicles", "#2F81C5", "#205988", 1580, 1280, 8)
non_vehicle_plot <- create_plot(non_vehicle_data, "Non-Vehicles (Pedestrians, Cyclists, PMD)", "#2DA5B2", "#217E88", 78, 68, 0.5)
